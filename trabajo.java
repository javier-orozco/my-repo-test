...
public class principal {
    ...
    static void salario(){
        ...
        int eps = salarioBruto * 4/100;
        int pension = eps;
        int otros = salarioBruto*2/100;
        int deduccion = eps+pension+otros;
    ...
    static void parqueadero(){
        ...
        int pagaInicial = horas * 2000;
        int iva = pagaInicial * 20/100;
        int pagaFinal = pagaInicial + iva;
